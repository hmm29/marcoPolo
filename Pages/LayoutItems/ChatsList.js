...
var ChatsList = React.createClass({
    ...
    render() {
        return (
            <View style={{flex: 1, backgroundColor: 'rgba(2,3,15,0.98)'}}>
                {/* background color val must be rgba with alpha */}
                <View>
                    {this._renderHeader()}
                </View>
                ...
                <ListView
                    ...
                    scrollRenderAheadDistance={200} style={{width: Display.width}}/>
                <Modal
                    ...
                    <View style={styles.modalView}>
                        ...
                        <TouchableOpacity activeOpacity={0.8}>
                            <Text style={styles.loadingModalFunFactText}>
